  ...
  return (
    ...
    >
      <div className="w-full bg-secondary rounded-[12px] flex flex-col justify-between items-center mb-[40px]">
        <div className="flex animate-pulse absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/ items-center justify-center text-textAccent text-4xl font-bold mb-10">
          KickStart GO
        </div>
