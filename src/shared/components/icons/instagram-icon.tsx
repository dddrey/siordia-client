...
const InstagramIcon = ({
  ...
  const { setHapticFeedback, openTelegramLinkFunc } = useTelegram();

  const handleClick = () => {
    setHapticFeedback();
    openTelegramLinkFunc(
      "https://www.instagram.com/coach_siordia?igsh=eG94cGpsczFlbnJ4"
    );
  };
  ...
  return (
    ...
    >
      <path
        ...
        clipRule="evenodd"
      />
      <path fill={props.color} d="M18 5a1 1 0 1 0 0 2 1 1 0 0 0 0-2Z" />
      <path
        fill={props.color}
        fillRule="evenodd"
